        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePublication = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Likes_Reponses_ReponseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_ReponseId",
                table: "Likes",
                column: "ReponseId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_ReponseId",
                table: "Likes",
                columns: new[] { "UserId", "ReponseId" },
                unique: true);
